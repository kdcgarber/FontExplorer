...
void helpMenu(int currentRow) {
	...
	case 0: 
		...
		break;
	case 1:
		wprintf(L"      \x2502 \x1b[1mright arrow\x1b[0m : move cursor right                  '\x1b[1mc\x1b[0m' : remove a dot and move forward a position\n");
		break;
	case 2:
		wprintf(L"      \x2502 \x1b[1mdown  arrow\x1b[0m : move cursor down                   '\x1b[1mv\x1b[0m' : add a dot and moves forward a position\n");
		break;
	case 3:
		wprintf(L"      \x2502 \x1b[1mup    arrow\x1b[0m : move cursor up                     '\x1b[1mq\x1b[0m' : quit\n");
		break;
	case 4:
...
int main()
{
	...
	std::wstring fileNameW = L"\\outimage.bmp";
	fileName = fileNameW.c_str();
